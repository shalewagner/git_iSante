...
<input type="text" name="BddyAIDSTrainCmpltDate" id="BddyAIDSTrainCmpltDate" <?=  getData("BddyAIDSTrainCmpltDate","text") ?> />
			        ...
			        <tr>
			                <td id="BddyInfoUnderstandingTextTitle"> <?=$support[$lang][5]?> </td>
			                <td valign="top">
			                        <input type="radio" value="1" name="BddyInfoUnderstanding[]"  <?= getData("BddyInfoUnderstanding","radio",1)?> > <?= $yesNo[$lang][0] ?>
			                        <input type="radio" value="2" id="BddyInfoUnderstanding" name="BddyInfoUnderstanding[]" <?= getData("BddyInfoUnderstanding","radio",2)?> > <?= $support[$lang][6] ?> 
			        ...
			        <tr>
			                ...
			                <td valign="top">
			                        <input type="radio" value="1" id="BddyChng1" name="BddyChng[]" <?= getData("BddyChng","radio",1)?> 
/> <?= $support[$lang][8] ?> <input type="text" maxlength="500" size="30" name="BddyChngReason" id="BddyChngReason" <?= 
getData("BddyChngReason", "text") ?>/>	
				...
				<tr>
					<table>
						<tr>
							...
							<td colspan=3 
style="text-align:center;"><?=$arvInitiation[$lang][2]?>
						</tr>
						<tr>
