...
"patientStatus" => array (
		"en" => array (
			...
			"7" => "Recent on Pre-ART",
			"8" => "Actifs in Pre-ART",
			"9" => "Lost to follow up on Pre-ART",
			"10" => "Death on Pre-ART",
			"11" => "Transferred on Pre-ART"			
			),
		"fr" => array (
		    "-1" => "ARV Status ",
			"0" => "PRE-ARV Status ",
			...
			"7" => "Récents sous Pré-ARV",
			"8" => "Actifs sous Pré-ARV",
			"9" => "Perdus de vue sous Pre-ART",
			"10" => "Décédés sous Pre-ART",
			"11" => "Transférés sous Pre-ART")
			),
