...
"patientStatus" => array (
		"en" => array (
			...
			"3" => "Lost to follow up on ART",
			"4" => "Death on ART",
			"5" => "stopped on ART",
			"6" => "Transferred on ART",
			"7" => "Recent during the transition period",
			"8" => "Active during the transition period",
			"9" => "Lost of follow up  during the transition period",
			"10" => "Died during the transition period",
		...
		"fr" => array (
			...
			"4" => "Décédés sous ARV",
			"5" => "Arrêtés sous ARV",
			"6" => "Transférés sous ARV",
			"7" => "Récent durant la période de transition",
			"8" => "Actif durant  la période de transition",
			"9" => "Perdus de vue durant la période de transition",
			"10" => "Décédé durant la période de transition",
			"11" => "Transféré durant la période de transition")
			),
