<?php
/**
 * Account edit page template
 *
 * @author	Svend Sorensen
 * @version	$Id: edit.tmpl.php 141 2006-10-25 21:00:33Z svends $
 */
?>
...
<?php } // End if ?>
	...
	<?php 
		if (isset($_GET['passFlag'])) print "<input type=\"hidden\" name=\"passFlag\" value=\"true\" />";
	?>
	<fieldset>
		<fieldset>
			<legend><?php print gettext("Account information"); ?></legend>
			<label for="username"><?php print gettext("Username"); ?>:</label>
			<input readonly="readonly" type="hidden" name="username" id="username" value="<?php print $form['username'] ?>" />
			<?php print $form['username']; ?><br />
