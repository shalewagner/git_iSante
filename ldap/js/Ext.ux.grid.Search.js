 ...
 * </ul>
 * @version   1.1.1
 * @revision  $Id: Ext.ux.grid.Search.js 595 2009-02-25 20:56:37Z jozo $
 *
...
Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
	...
	/**
	 * @cfg {String} iconCls Icon class for menu button (defaults to "original-icon-magnifier")
	 */
	,iconCls:'original-icon-magnifier'
