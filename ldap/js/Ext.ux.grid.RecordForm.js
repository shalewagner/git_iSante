 ...
 * @date      4. April 2008
 * @version   1.0
 * @revision  $Id: Ext.ux.grid.RecordForm.js 589 2009-02-21 23:30:18Z jozo $
 *
...
Ext.extend(Ext.ux.grid.RecordForm, Ext.util.Observable, {
	 ...
	 */
	 ,cancelIconCls:'original-icon-cancel'
	...
	,createFormConfig:function() {
		...
		fields.each(function(f, i) {
			...
			//ignore fields that aren't defined -- this is an adhoc fix -- still don't know what is generating those empty fields
			if(!f.name){
			return;
			}
