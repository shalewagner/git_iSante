...
function renderBirthHistory($num, $numString) {
  ...
  <table id="birthHistoryTable<?= $num ?>">
    <tr><td><?= $numString ?></td></tr>
    <tr><td><?= renderRadio('birthHistoryMortality' . $num, 0, '&nbsp;') ?></td></tr>
    <tr><td><?= renderRadio('birthHistoryMortality' . $num, 1, '&nbsp;') ?></td></tr>
    <tr><td><?= renderRadio('birthHistoryMortality' . $num, 2, '&nbsp;') ?></td></tr>
    <tr><td><?= renderRadio('birthHistoryMortality' . $num, 3, '&nbsp;') ?></td></tr>
    ...
    <tr><td><?= renderRadios('birthHistorySex' . $num, array(_('Masc.'), _('Fém.'))) ?></td></tr>
  </table>
  ...
  <tr>
   ...
   <tr>
	 ...
	 <table>
	    ...
	    <tr>
	      <td id="laborTarCell" class="sectionLines">
	    ...
	    <tr>
	       <td>
		  <?= _('Prophylaxie ARV') ?>
		  <?= renderRadio('laborProphylaxisArv', 0, 'NVP') ?>
		  <?= renderRadio('laborProphylaxisArv', 1, 'AZT+3TC') ?>
		  <?= renderRadio('laborProphylaxisArv', 5, 'AZT+3TC+NVP') ?>
		  <!-- options form old form
		  <?= renderRadio('laborProphylaxisArv', 2, _('Aucune')) ?>
		  <?= renderRadio('laborProphylaxisArv', 3, _('TAR Spécifier')) ?>
		  <?= renderRadio('laborProphylaxisArv', 4, 'AZT') ?>
	 ...
	 <table>
	    ...
	    <tr>
               <td>
                  ...
                  <?= renderRadio('laborLocation', 1, _('Hôpital/Dispensaire')) ?>
               </td>
            </tr>
	    <tr>
	      <td>
	    ...
	    <tr>
	      <td>
		<?= _('Counseling sur la Nutrition du (des) Nné (s)') ?>
   ...
   <tr>
	 ...
	 <tr>
	   <td style="vertical-align:top;">
	     <table>
	       <tr><td>&nbsp;</td></tr>
	       <tr><td colspan="2"><?= _('Naissance Vivante') ?></td></tr>
	       <tr><td><?= _('Mort Fœtale') ?> :</td><td><?= _('Macérée') ?></td></tr>
	       <tr><td></td><td><?= _('Non Macérée') ?></td></tr>
	       <tr><td colspan="2"><?= _('Mort Néonatale') ?></td></tr>
	       <tr><td colspan="2" style="height:2em;">APGAR : 1mn - 5mn</td></tr>
	       <tr><td colspan="2" style="height:2em;"><?= _('Poids du (ou des) Nné(s)') ?></td></tr>
	       <tr><td colspan="2" style="height:2em;"><?= _('Périmètre Crânien et Taille') ?></td></tr>
	       <tr><td colspan="2"><?= _('Sexe') ?></td></tr>
	     </table>
	   </td>
   ...
   <tr>
     <td colspan="2" class="s_header"><?= _('EVOLUTION') ?></td>
   </tr>
   <tr>
     <td colspan="2">
       <?= renderRadios('laborEvolution', array(_('Référée en suites de couche'),
						_('Référée en pathologie'),
						_('Exéatée'),
						_('Décédée'))) ?>
       <?= _('Autre, précisez') ?>
