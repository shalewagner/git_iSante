  ...
  <table class=\"header\">
    ...
    <tr>
        <td colspan=\"4\" width=\"100%\"><table><tr><td id=\"nextVisitD1Title\">&nbsp;</td><td  ><input tabindex=\"2202\" id=\"nextVisitD1\" name=\"nextVisitD1\" value=\"" . getData ("nextVisitDD", "textarea") . "/" . getData ("nextVisitMM", "textarea") . "/" . getData ("nextVisitYY", "textarea") . "\" type=\"text\" size=\"8\" maxlength=\"8\"></td><td>" .
         	$nextVisitDD[$lang][1] . " <input tabindex=\"2202\" id=\"nextVisitDD\" name=\"nextVisitDD\" value=\"" . getData ("nextVisitDD", "textarea") . "\" type=\"hidden\"><input tabindex=\"2203\" id=\"nextVisitMM\"  name=\"nextVisitMM\" value=\"" . getData ("nextVisitMM", "textarea") . "\" type=\"hidden\"><input tabindex=\"2204\" id=\"nextVisitYY\" name=\"nextVisitYY\" value=\"" . getData ("nextVisitYY", "textarea") . "\" type=\"hidden\"> <i>" . $nextVisitYY[$lang][2] . "</i></td></tr></table>
       </td>
    </tr>
 </table>
