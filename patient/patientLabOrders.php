...
function getHistory($pid, $lang) {
	...
	0,
	null
	from otherLabs where ((result is null and result = '') or isdate(ymdToDate(resultDateYy,resultDateMm, resultDateDd)) = 1) and patientid = '" . $pid . "')
	order by 1 DESC, sectionOrder, testOrder";  
