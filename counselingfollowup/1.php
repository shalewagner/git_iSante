...
<input type="text" name="BddyInfoUnderstandingText" />
			        ...
			        <tr>
			                ...
			                <td valign="top">
			                        <input type="radio" value="1" id="BddyChng1" name="BddyChng[]" <?= getData("BddyChng","radio",1)?> /> <?= $support[$lang][8] ?>  <input 
type="text" maxlength="500" size="30" name="BddyChngReason" id="BddyChngReason" <?= getData("BddyChngReason", "text") ?> />
...
getData("ptRcvdRefAndSrvcsReason","text")?> />
				...
				<tr>
					...
					<td> <input type="radio" value="1" <?= getData("ptMissedCinicVisit","radio",1)?>  
name="ptMissedCinicVisit[]"> <?= $followUpCare[$lang][4] ?> <input type="text" name="ptMissedCinicVisitDate" id="ptMissedCinicVisitDate" <?= 
getData("ptMissedCinicVisitDate","text")?>/>  
...
type="text" name="ptMissOtherAptsDate" id="ptMissOtherAptsDate" <?= getData("ptMissOtherAptsDate","text") ?> />
...
name="other1Text" <?= getData("other1Text", "text") ?> /><br>
					<?= $services[$lang][8] ?> <input type="text" id ="NextPsychAppt" name="NextPsychAppt" <?= getData("NextPsychAppt","text") ?> /> <br> 
