   ...
   <tr>
    <td>
     <table class=\"b_header_nb\" border=\"0\" cellspacing =\"0\" cellpadding=\"0\">
      ...
      <tr bgcolor=\"" . swicthBgColor() . "\">
       <td class=\"sm_header_cnt_np\"><input tabindex=\"" . ($tabIndex + 2) . "\"  class=\"clinicalExam\"  id=\"physicalGeneral1\"  name=\"physicalGeneral[]\" " . getData ("physicalGeneral", "radio", 1) . " type=\"radio\" value=\"1\"></td>
       <td class=\"sm_header_cnt_np\"><input tabindex=\"" . ($tabIndex + 3) . "\"  class=\"clinicalExam\"  id=\"physicalGeneral2\" name=\"physicalGeneral[]\" " . getData ("physicalGeneral", "radio", 2) . " type=\"radio\" value=\"2\"></td>
       <td class=\"sm_header_cnt_np\"><input tabindex=\"" . ($tabIndex + 4) . "\"  class=\"clinicalExam\"  id=\"physicalGeneral4\" name=\"physicalGeneral[]\" " . getData ("physicalGeneral", "radio", 4) . " type=\"radio\" value=\"4\"></td>
       <td class=\"small_cnt\">" . $physicalGeneral[$lang][1] . "</td>
       <td valign=\"top\" rowspan=\"12\"  bgcolor=\"" . $nonColoredBg.
          "\">&nbsp;&nbsp;<textarea tabindex=\"" . ($tabIndex + 38) .
          "\" id=\"clinicalExam\"  class=\"clinicalExam\"  id=\"clinicalExam\"  name=\"clinicalExam\" cols=\"60\" rows=\"16\">" .
      ...
      <tr bgcolor=\"" . swicthBgColor() . "\">
       ...
       <td class=\"small_cnt\">" . $physicalOral_1[$lang][0] . "</td>
      </tr>
      <tr bgcolor=\"" . swicthBgColor() . "\">
	...
	if (getUiConfig(getSessionUser()) == "2" || getUiConfig(getSessionUser()) == "3"){
      ...
      <tr bgcolor=\"" . swicthBgColor() . "\">
       ...
       <td class=\"small_cnt\">" . $physicalCardio_1[$lang][0] . "</td>
      </tr>
      <tr bgcolor=\"" . swicthBgColor() . "\">
      ...
      <tr bgcolor=\"" . swicthBgColor() . "\">
       ...
       <td class=\"small_cnt\">" . $physicalUro_1[$lang][0] . "</td>
      </tr>
      <tr bgcolor=\"" . swicthBgColor() . "\">
       ...
       <td class=\"small_cnt\">" . $physicalMusculo_1[$lang][0] . "</td>
      </tr>
      <tr bgcolor=\"" . swicthBgColor() . "\">
       ...
       <td class=\"sm_header_cnt_np\"><input tabindex=\"" . ($tabIndex + 33) . "\"  class=\"clinicalExam\"  id=\"physicalNeuro2\" name=\"physicalNeuro[]\" " . getData ("physicalNeuro", "radio", 2) . " type=\"radio\" value=\"2\"></td>
       ...
       <td class=\"small_cnt\">" . $physicalNeuro_1[$lang][0] . "</td>
      </tr>
      <tr bgcolor=\"" . swicthBgColor() . "\">
