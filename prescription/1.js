Ext.onReady(function() {
	...
	{	
		...
		if(suffix == 'DispDateDt')
		{
			...
			(Ext.get(root + 'DispAltNumPills')).on('blur', function(){
			...
			errMsg = Ext.util.isValueInBound(document.getElementById(root + 'DispAltNumPills'),document.getElementById(root + 'DispAltNumPillsTitle'), '1','','');
				...
				Ext.get(root + 'StdDosage').on('click', function(){
					...
					errMsg = Ext.util.validateNumDaysDesc(document.getElementById(this.id.substring(0,this.id.length-9) + 'StdDosage'),document.getElementById(this.id.substring(0,this.id.length-9) + 'AltDosageSpecify'),document.getElementById(this.id.substring(0,this.id.length-9) + 'NumDaysDesc'),document.getElementById(this.id.substring(0,this.id.length-9) + 'NumDaysDescTitle'));
			...
			if(prefix != 'other')
			{
				...
				errMsg = Ext.util.validateRxAltDosageSpecify(document.getElementById(root + 'StdDosage'),document.getElementById(root + 'AltDosageSpecify'),document.getElementById(root + 'NumDaysDesc'),document.getElementById(root + 'AltDosageSpecifyTitle'),document.getElementById(root + 'NumDaysDescTitle'));
			...
			Ext.get(root + 'DispAltDosageSpecify').on('blur', function(){
				...
				errMsg = Ext.util.validateRxAltDosageSpecify(document.getElementById(this.id.substring(0,this.id.length-20) + 'StdDosage'),document.getElementById(this.id),document.getElementById(this.id.substring(0,this.id.length-20) + 'DispAltNumDaysSpecify'), document.getElementById(this.id + 'Title'));
				errCount = Ext.util.showErrorHead(errFields,errMsgs,this.id,errMsg,errCount);
	...
	Ext.util.disableAssoDt(startedArv,arvStartDateDtFmt,document.getElementById('arvStartDate'),radioArr, true);
	for(var i=0;i<2;i++)
	{
		Ext.get('startedArv' + i).on('click', function(){
			Ext.util.disableAssoDt(document.getElementById('startedArv1'),arvStartDateDtFmt,document.getElementById('arvStartDate'),radioArr,true);
