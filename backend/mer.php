...
"-9"=> array(0, " where HIVForm=1 and arvPatient=1  and s.patientID in (select patientID from encValidAll p where p.visitDate>=DATE_ADD(s.visitDate, interval -6 month))", NULL),
