   ...
   <tr>
    <td>
     <table class=\"b_header_nb\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\">
      ...
      <tr class=\"alt\">
       <td><input tabindex=\"" . ($tabIndex + 1) .  "\" name=\"abPain\" " . getData ("abPain", "checkbox") .  " type=\"checkbox\" value=\"On\">" .  $abPain[$lang][1] . "</td> 
      ...
      <tr>
       <td><input tabindex=\"" . ($tabIndex + 2) . "\" name=\"anorexia\" " . getData ("anorexia", "checkbox") . " type=\"checkbox\" value=\"On\">" . $anorexia[$lang][1] . "</td>
